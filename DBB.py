...
class IdentityBasedConv1x1(nn.Conv2d):
    ...
    def forward(self, input):
        ...
        result = F.conv2d(input, kernel, None, stride=1, padding=0,
    ...
    def get_equivalent_kernel_bias(self):
        ...
        if hasattr(self, 'dbb_1x1'):
            k_1x1, b_1x1 = transI_fusebn(
                self.dbb_1x1.conv.weight, self.dbb_1x1.bn)
...
if __name__ == "__main__":
    m = DiverseBranchBlock(3,6,3,padding=1)
    input = torch.zeros(5,3,64,64)
    print(m(input).shape)