...
from piconas.predictor.nas_embedding_suite.nb123.nas_bench_301.cell_301 import Cell301
...
class NASBench301:
    ...
    def get_adj_op(self, idx, space=None, bin_space=None):
        ...
        return convert_arch_tuple_to_idx(
            [(str(x[0]), self.op_dict[x[1]]) for x in arch_desc['arch'][0]]
        )
