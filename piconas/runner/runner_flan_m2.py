...
parser.add_argument(
    '--joint_repr', action='store_true'
)  # If True, uses the joint representation of the search space for CATE and Arch2Vec
parser.add_argument(
...
for tr_ in range(args.num_trials):
    ...
    for transfer_sample_count in transfer_sample_counts:
        ...
        transfer_dataloader, transfer_indexes = get_dataloader(
            args,
            embedding_gen,
            args.transfer_space,
