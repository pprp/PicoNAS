...
CUDA_VISIBLE_DEVICES=1 python tools/train.py --config configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201ShrinkTrainer --log_name ssshrinkexpand_nb201_spos_uniform-sampling_exp3.0_metric-expand-flops --dataset cifar10 --crit ce --lr 0.025 --type flops

# TODO expand operation with balanced (nwot) sample strategy.
CUDA_VISIBLE_DEVICES=2 python tools/train.py --config configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201ShrinkTrainer --log_name ssshrinkexpand_nb201_spos_uniform-sampling_exp3.0_metric-expand-nwot --dataset cifar10 --crit ce --lr 0.025 --type nwot

# TODO there are bugs in shrink, fixed. rerun
CUDA_VISIBLE_DEVICES=0 python tools/train.py --config configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201ShrinkTrainer --log_name ssshrinkexpand_nb201_spos_uniform-sampling_exp3.0_flops-guide-metric-200_sample-num_expand6shrink3-rerun --dataset cifar10 --crit ce --lr 0.025 --type uniform

# TODO only shrink 3 times
CUDA_VISIBLE_DEVICES=0 python tools/train.py --config configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201ShrinkTrainer --log_name ssshrinkexpand_nb201_spos_uniform-sampling_exp3.0_flops-guide-metric-200_sample-num_shrink3-rerun --dataset cifar10 --crit ce --lr 0.025 --type uniform
...
CUDA_VISIBLE_DEVICES=0 python tools/train.py --config configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201ShrinkTrainer --log_name ssshrinkexpand_nb201_spos_uniform-sampling_exp3.0_flops-guide-metric-200_sample-num_expand6-num_expand_every_5_epochs-rd-5-range-new_rank_diff-flops-balaced-sample --dataset cifar10 --crit ce --lr 0.025 --type flops
