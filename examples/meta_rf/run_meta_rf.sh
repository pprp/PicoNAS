...
CUDA_VISIBLE_DEVICES=1 python ./train_timm.py /home/stack/data_sdc/datasets/subImageNet  --model MobileNetv2MetaReceptionField --trainer MetaTrainer -b 64 --sched cosine --epochs 60 --decay-epochs 2.4 --decay-rate .973 --opt rmsproptf --opt-eps .001 -j 7 --warmup-lr 1e-6 --weight-decay 1e-5 --drop 0.2 --drop-path 0.2 --model-ema --model-ema-decay 0.9999
