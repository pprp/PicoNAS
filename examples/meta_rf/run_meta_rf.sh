...
# for debug
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1 ./train_timm.py /home/inspur/data/subImageNet/  --model MobileNetv2MetaReceptionField --trainer MetaTrainer -b 64 --opt nesterov --momentum 0.9 --lr 0.1 --epochs 140 --sched cosine
