...
CUDA_VISIBLE_DEVICES=1 python ../../tools/train.py --config ../../configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201Trainer --log_name normal_nb201_spos_uniform-sampling_exp-rerun --dataset cifar10 --crit ce --lr 0.025 --type uniform --data_dir ../../data/cifar
...
# 3. Sandwich Rule
CUDA_VISIBLE_DEVICES=1 python ../../tools/train.py --config ../../configs/spos/spos_cifar10.py --model_name OneShotNASBench201Network --trainer_name NB201Trainer --log_name normal_nb201_spos_sandwich-sampling_exp-rerun --dataset cifar10 --crit ce --lr 0.025 --type sandwich  --data_dir ../../data/cifar
