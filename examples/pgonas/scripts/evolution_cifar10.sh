...
CUDA_VISIBLE_DEVICES=0 python ../../tools/searcher/search_evo_nb201.py \
    --config ../../configs/spos/spos_cifar10.py \
    --data_dir ../../data/cifar --dataset cifar10 \
    --log_name evolution_spos_train_test_c10_seed6_run0 \
    --seed 42 \
...
CUDA_VISIBLE_DEVICES=0 python ../../tools/searcher/search_evo_nb201.py \
    --config ../../configs/spos/spos_cifar10.py \
    --data_dir ../../data/cifar --dataset cifar10 \
    --log_name evolution_spos_train_test_c10_seed66_run1 \
    --seed 42 \
...
CUDA_VISIBLE_DEVICES=0 python ../../tools/searcher/search_evo_nb201.py \
    --config ../../configs/spos/spos_cifar10.py \
    --data_dir ../../data/cifar --dataset cifar10 \
    --log_name evolution_spos_train_test_c10_seed42_run3 \
    --seed 42 \
...
CUDA_VISIBLE_DEVICES=0 python ../../tools/searcher/search_evo_nb201.py \
    --config ../../configs/spos/spos_cifar10.py \
    --data_dir ../../data/cifar --dataset cifar10 \
    --log_name evolution_spos_train_test_c10_seed43_run4 \
    --seed 42 \
