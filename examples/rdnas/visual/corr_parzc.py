...
df = pd.read_csv('./examples/rdnas/visual/predicts_targets.csv')  # Replace 'your_data.csv' with your CSV file path
x_label = 'ParZC score'
...
plt.scatter(data1, data2, color='blue', marker='o', s=100, alpha=0.5, label='Data Points')
