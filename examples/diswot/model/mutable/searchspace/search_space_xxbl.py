...
from model.mutable.super_blocks import SuperConvKXBNRELU
from model.mutable.SuperResK1KXK1 import (SuperResK1K3K1, SuperResK1K5K1,
                                          SuperResK1K7K1)
# from PlainNet import SuperResKXKX, SuperResK1KXK1
from model.mutable.SuperResKXKX import SuperResK3K3, SuperResK5K5, SuperResK7K7
