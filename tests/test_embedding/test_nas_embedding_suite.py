if __name__ == '__main__':
    ...
    if test_nb1:
        ...
        for idx in range(10):
            ...
            print(nb101.arch2vec_nb101[idx]['valid_accuracy'] -
                  nb101.nb1_api.get_metrics_from_hash(
                      nb101.hash_iterator_list[idx])[1][108][0]
    ...
    if test_nb3:
        ...
        if nb301.use_nb3_performance_model:
            ...
            print('=' * 53)
            for idx in range(10):
                print(nb301.cate_nb301['predicted_accs'][idx] -
                      nb301.get_valacc(idx))
            for idx in range(1000000, 1000040, 1):
                print(nb301.cate_nb301_zcp['cifar10'][list(
                    nb301.cate_nb301_zcp['cifar10'].keys())[idx - 1000000]]
                      ['val_accuracy'] - nb301.get_valacc(idx))
            print('=' * 53)
    if test_tb1mic:
        print('=' * 53)
