if __name__ == '__main__':
    test_nb1, test_nb2, test_nb3, test_tb1mic, test_nds = (
        False,
        False,
        False,
        True,
    ...
    if test_nb1:
        ...
        for idx in range(10):
            ...
            print(
                nb101.arch2vec_nb101[idx]['valid_accuracy']
                - nb101.nb1_api.get_metrics_from_hash(nb101.hash_iterator_list[idx])[1][
                    108
                ][0]['final_validation_accuracy']
            )
    if test_nb2:
        print('=' * 53)
