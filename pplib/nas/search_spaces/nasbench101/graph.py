...
from pplib.utils import get_dataset_api
...
class NasBench101SearchSpace(Graph):
    ...
    def query(
        ...
        if self.get_spec() is None:
            raise NotImplementedError(
                'Cannot yet query directly from the pplib.nas object')
    ...
    def set_spec(self, spec, dataset_api=None):
        # TODO: convert the pplib.nas object to this spec
        # convert_spec_to_pplib.nas(spec, self)
