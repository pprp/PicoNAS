...
from pplib.nas.mutables.dynamic.dynamic_attention import AttentionSuper
from pplib.nas.mutables.dynamic.dynamic_embedding import PatchembedSuper
from pplib.nas.mutables.dynamic.dynamic_layernorm import LayerNormSuper
from pplib.nas.mutables.dynamic.dynamic_linear import LinearSuper
from pplib.nas.mutables.utils import trunc_normal_
from pplib.utils.utils import DropPath
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self,
        ...
        # the configs of super arch of the encoder,
        # three dimension [embed_dim, mlp_ratio, and num_heads]
        ...
        #      getattr(args, 'activation_dropout', 0)
    ...
    def forward(self, x):
        ...
        Args:
            x (Tensor): input to the layer of shape
                `(batch, patch_num , sample_embed_dim)`
