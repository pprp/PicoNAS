...
from pplib.models.nats.nats_ops import SlimmableConv2d, SwitchableBatchNorm2d
from pplib.models.nats.nats_ops import ResNetBasicblock, InferCell
    ...
    def __init__(self, reduction=False):
        ...
        if reduction:
            ...
            self._mix_ops = InferCell(
                self.genotype, self._max_C, self._max_C, 1, affine=True, track_running_stats=True)
