...
from nanonas.nas.search_spaces.nasbench101.conversions import get_children
from nanonas.nas.search_spaces.nasbench101.primitives import ModelWrapper
from nanonas.nas.search_spaces.transbench101.tnb101.model_builder import \
    create_model
"""
...
def convert_naslib_to_transbench101_micro(naslib_object):
    ...
    edge_op_dict = {(i, j): ops_to_tb101[cell.edges[i, j]['op'].get_op_name]
                    for i, j in cell.edges}
