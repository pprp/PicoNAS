...
from nanonas.utils import get_dataset_api
...
class NasBench101SearchSpace(Graph):
    ...
    def query(
        ...
        if self.get_spec() is None:
            raise NotImplementedError(
                'Cannot yet query directly from the nanonas.nas object')
    ...
    def set_spec(self, spec, dataset_api=None):
        # TODO: convert the nanonas.nas object to this spec
        # convert_spec_to_nanonas.nas(spec, self)
    ...
    def sample_random_architecture(self, dataset_api, load_labeled=False):
        ...
        nanonas.nas object accordingly.
