...
from nanonas.models.nds import AnyNet, NetworkCIFAR, NetworkImageNet
...
def get_transbench101_api(dataset):
 ...
 from https://www.noahlab.com.hk/opensource/vega/page/doc.html?path=datasets/transnasbench101'
    ...
    from nanonas.nas.search_spaces import TransNASBenchAPI
...
def get_nasbench101_api(dataset=None):
    import nanonas.nas.utils.nb101_api as api
