...
# Architecture data
architecture_data = json.load(open("/data2/dongpeijie/bench/zc_nasbench101_layerwise_5000.json", "r"))['cifar10']
...
for idx, zc_name in tqdm(enumerate(zc_name_list)):
    ...
    # Plot the data
    plt.scatter(embedded_data[:, 0], embedded_data[:, 1], s=marker_size, c=marker_color, alpha=0.2) 
