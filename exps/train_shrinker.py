...
def get_args():
    ...
    parser.add_argument('--seed', type=int, default=20, help='seed of experiments')
    ...
    parser.add_argument(
        '--every_n_epochs', type=int, default=5, help='shrink or expand every n times'
    )
...
def main():
    ...
    if cfg.dataset == 'cifar10':
        ...
        raise NotImplementedError(f'Not Support Type of datasets: {cfg.dataset}.')
