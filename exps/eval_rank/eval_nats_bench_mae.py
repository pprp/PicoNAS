...
from piconas.datasets.data_simmim import build_loader_simmim
from piconas.evaluator import NATSEvaluator
from piconas.models.nats.nats_supernet import MAESupernetNATS
from piconas.trainer.nats_trainer import MAENATSTrainer
...
if __name__ == '__main__':
    ...
    # get trainer
    trainer = MAENATSTrainer(supernet, mutator=None,
